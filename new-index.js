...
bot.setGreetingText("Bonjour, je suis Delphos et je suis la pour t'aider. ")
...
bot.hear(['hello', 'hey', 'sup', 'bonjour', 'coucou', 'hi'], (payload, chat)=>{
  chat.getUserProfile().then((user) => {
    chat.say(`Bonjour ${user.first_name}, Comment te sens-tu aujourd'hui ?`)
  })
})
